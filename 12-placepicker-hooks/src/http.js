...
const initialUserPlaces = [];

// Initialize localStorage if it doesn't exist
if (!localStorage.getItem('availablePlaces')) {
  localStorage.setItem('availablePlaces', JSON.stringify(initialAvailablePlaces));
}
if (!localStorage.getItem('userPlaces')) {
  localStorage.setItem('userPlaces', JSON.stringify(initialUserPlaces));
}
...
export async function fetchAvailablePlaces() {
  await simulateDelay();
  const places = JSON.parse(localStorage.getItem('availablePlaces') || '[]');
  return places;
}
